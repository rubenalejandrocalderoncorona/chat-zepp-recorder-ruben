...
class PrivacyWarningScreen extends ListView {
  ...
  build() {
    return [
      ...
      new TextComponent({
        text: t("This application is an frontend for OpenRouter \u2014 unified LLMs API provider. By using this application, you agree with Privacy Policy of selected model provider, which you can find online."),
        marginV: 4
      }),
      new TextComponent({
        text: t("AI models can give your incorrect or harmful response, developer(s) of AI Chat are not responsible for anything that you got as response. Please, do not use AI as an medical consultant."),
        marginV: 4
      }),
      new TextComponent({
        text: t("Keep in mind that this application and/or your preferred AI model can stop working at any time. We didn't provide any guarantees."),
        marginV: 4
      }),
